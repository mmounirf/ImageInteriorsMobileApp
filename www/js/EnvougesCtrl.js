ImageInteriorsApp.controller('EnvougesCtrl', function( $scope, $http, DataLoader, $timeout, $ionicSlideBoxDelegate, $rootScope, $log, $ionicLoading, $state, $ionicModal) {
  var productsApi = $rootScope.url + 'products?tags=73';
